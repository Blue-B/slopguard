...
export const metadata: Metadata = {
	title: "SlopGuard: 패턴 추적 상세 - Pro",
	description:
		"크로스 레포 패턴 클러스터의 레포 영향과 커밋 증거를 실제 데이터로 확인합니다.",
};
...
const copy: CampaignDetailCopy = {
	...
	nav: [],
	loading: "패턴 증거 불러오는 중…",
	error: "패턴을 불러오지 못했습니다",
	heading: "PATTERN EVIDENCE",
	subhead:
		"/org가 팀 운영 현황이라면, 여기는 여러 레포에 반복된 하나의 패턴을 추적하는 패턴 조사 화면입니다.",
	...
	impactSubhead: "패턴 API에서 집계한 레포별 격리/정상화 영향입니다.",
	authorsLabel: "작성자",
};

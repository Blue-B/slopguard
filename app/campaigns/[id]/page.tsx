...
import CampaignDetailConsole, { type CampaignDetailCopy } from "@/app/components/CampaignDetailConsole";
import PlanGate from "@/app/components/PlanGate";
import SiteFooter from "@/app/components/SiteFooter";

export const metadata: Metadata = {
	title: "SlopGuard: Campaign Detail - Pro",
	description: "Drill into one cross-repo campaign cluster with live repo impact and commit evidence.",
};
...
const copy: CampaignDetailCopy = {
	...
	subhead: "Live drill-down built from the campaign API. Repo impact stays tied to installed GitHub data.",
